        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              @if (Auth::check())
                <li>Welcome, {{ Auth::user()->firstname }} {{ Auth::user()->lastname }} {{ link_to_route('user.logout', "(log out)") }}</li> 
          ...
          <div class="col-lg-3">
            <div class="list-group">
              @if (Auth::user()->category == "Employer")
                <a href="{{ URL::to('employer') }}" class="list-group-item">Employer Posted Jobs</a>
